...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, Linear `AHA-42`, `Fixes AHA-42`, etc.) — fetch via the workflow in `docs/agents/issue-tracker.md`.
